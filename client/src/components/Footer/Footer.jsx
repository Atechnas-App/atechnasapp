      ...
      <div className="main-footer-container">
        <div className="upper-footer-container">
          ...
          <div className="upper-footer-container-center">
            ...
            <a
              href="mailto:atechnasapp@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className="down-footer-container">
          ...
          <div>
            <h5 className="footer-legal">
              © 2021, All Rights Reserved - Atechna Inc.
            </h5>
          </div>
          <div className="footer-socialmedia">
            <a
              className="socialmedia-logo"
              href="https://www.linkedin.com/in/atechnas"
              target="_blank"
             rel="noreferrer">
              <img src={linkedin} className="socialmedia" alt="" />
            </a>
            <a
              className="socialmedia-logo"
              href="https://github.com/Atechnas-App"
              target="_blank"
             rel="noreferrer">
              <img src={github} className="socialmedia" alt="" />
            </a>
            <a
              className="socialmedia-logo"
              href="https://www.instagram.com/atechnasapp/"
              target="_blank"
             rel="noreferrer">
